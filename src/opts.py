...
def parse_args_knn():
   ...
   parser.add_argument('--HNSW_ef', type=int, default=500, help='Types of search')
   ...
   parser.add_argument('--print_freq', type=int, default=10000, help='Seed for reproducibility')
   parser.add_argument('--seed', type=int, default=0, help='Seed for reproducibility')
